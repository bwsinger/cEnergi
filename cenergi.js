...
//Lightbox for Projects
    $('.lightbox').click(function () {
        ...
        else if ( $(this).hasClass('ecofeedback_r') ) {
            $('.box p').html(ecofeedback_r);
        }
        ...
        else if ( $(this).hasClass('bearexperiment_r') ) {
            $('.box p').html(bearexperiment_r);
        }
        else if ( $(this).hasClass('farmarproject_r') ) {
            $('.box p').html(farmarproject_r);
        }
        else if ( $(this).hasClass('hems_r') ) {
            $('.box p').html(hems_r);
        }
        else if ( $(this).hasClass('hwr_r') ) {
            $('.box p').html(hwr_r);
        }
        else if ( $(this).hasClass('wved') ) {
            $('.box p').html(wved);
        }
        else if ( $(this).hasClass('dbtef_r') ) {
            $('.box p').html(dbtef_r);
        }
        else if ( $(this).hasClass('maedfs_r') ) {
            $('.box p').html(maedfs_r);
        }
