...
$(document).ready(function () {
    ...
    var greenfly = "<h3>Project Summary</h3><br>       GreenFlyer is a flight search tool that allows travelers to view and compare the CO2 emissions intensities of flights that meet their needs. For most of us, traveling by plane contributes more to our carbon footprint than any other single decision we make. However, the per-person CO2 emissions resulting from different flight selections for the same trip can vary more than 200%! With GreenFlyer, travelers can balance cost, preferences for travel times and airports, and concern for the environment.   <br><br><a target='_blank' href='http://greenfly.ucdavis.edu/'><button>Explore the Website</button></a>";
