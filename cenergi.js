...
$(document).ready(function () {
    ...
    var thermoostat = "<h3>Project Summary</h3><br>       cEnergi and the UC Davis Energy Conservation Office (ECO) developed a web application called TherMOOstat (cow-themed as cows are iconic to Davis), which allows occupants to report their thermal comfort and satisfaction with indoor temperatures, and to vote for conservative changes in thermostat settings. Facilities Management analyzes TherMOOstat data along with indoor and outdoor temperatures and work orders submitted to optimize thermostat settings and detect system issues for greater efficiency and occupant comfort.           <br><br><a target='_blank' href='https://thermoostat.ucdavis.edu/'><button>See TherMOOstat</button></a>   <br><br><ul><li>Pritoni, M., Salmon, K., Sanguinetti, A., Morejohn, J., & Modera, M. Thermal feedback for improved efficiency in university buildings. <i>Energy and Buildings</i>, 2017.</li>   <li>Sanguinetti, A., Pritoni, M., Salmon, K., & Meier, A. Scaling up a participatory thermal sensing program. <i>Energy Research & Social Science</i>.</li>  <li>Sanguinetti, A., Pritoni, M., Salmon, K., & Morejohn, J. (2017). TherMOOstat: Occupant feedback to improve comfort and efficiency on a university campus. . In <i>Proceedings of ACEEE 2016 Summer Study on Energy Efficiency in Buildings</i>.</li></ul>";
    ...
    var wved = "<h3>Project Summary</h3><br>        As a follow-up to our flag feedback study, we are expanding the West VIllage Energy Feedback project by developing a system of energy dashboards targeting all the energy and transportation research centers in West Village, including a community-level dashboard and four building-level dashboards. They will be stationed in communal, high-traffic areas on large touch-screen monitors. Feedback elements on the dashboard include consumption data disaggregated by end uses, as well as social, historical, and goal-based referents.    <br><br><a target='_blank' href='http://wved.ucdavis.edu/'><button>Visit the Dashboard</button></a>";
