...
$(document).ready(function () {
    ...
    var evexplorer = "<h3>Project Summary</h3><br>       cEnergi's partners at the Plug-in Hybrid & Electric Vehicle Research Center developed EV Explorer, a website that enables users to compare fuel costs for different vehicles based on their own commuting patterns, charging opportunities, vehicle mileage, and local fuel prices. All these inputs can be adjusted by the user for a tailored estimate of annual fuel costs for up to four user-selected vehicles at a time. Default vehicle comparisons promote consideration of plug-in hybrid electric and fully electric vehicles (PEVs). <br><br><a target='_blank' href='http://gis.its.ucdavis.edu/evexplorer/'><button>Explore the Site</button></a>                <br><br>        <h3>Research Summary</h3><br>       We evaluated EV Explorer through online experimentation, gauging users’ perceptions—before and after using the website—of their current fuel costs, potential savings with PEVs, attitude toward PEV charging, and intention to buy or lease a PEV in the future. Statistically significant changes in each of these variables validate EV Explorer as an educational tool and a persuasive eco-feedback intervention to promote the adoption of PEVs.  <br><br>  <ul><li><a target='_blank' href='https://its.ucdavis.edu/research/publications/?frame=https%3A%2F%2Fitspubs.ucdavis.edu%2Findex.php%2Fresearch%2Fpublications%2Fpublication-detail%2F%3Fpub_id%3D2569'>Sanguinetti, A., Nicholas, M. A., Tal, G., & Favetti, M. (2016). <i>EV Explorer: Evaluating a Vehicle Information Tool</i> (No. UCD-ITS-WP-16-01).</a></li></ul>";
